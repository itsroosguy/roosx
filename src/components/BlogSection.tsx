...
import { ArrowUpRight, BookOpen, Sparkles, Clock, CheckCircle2, Layers } from 'lucide-react';
      ...
      <div className="max-w-[1750px] mx-auto px-4 sm:px-6 lg:px-10 relative z-10 space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b pb-8 border-zinc-200/20">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-500/10 border border-[#FF7A1A]/40 text-[#FF7A1A] font-mono text-xs font-bold uppercase tracking-wider">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Thought Leadership & Works</span>
            </div>
        ...
        {/* CONTENT SWITCHING: BLOG INSIGHTS vs CASE STUDIES */}
          ...
          {activeTab === 'insights' ? (
            ...
            >
              ...
              >
                ...
                <div className="lg:col-span-7 relative overflow-hidden min-h-[320px] sm:min-h-[420px]">
                  <img
                ...
                <div className="lg:col-span-5 p-6 sm:p-10 flex flex-col justify-between space-y-6">
                  ...
                  <div className="pt-4 border-t border-zinc-800/80 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <div>
                        <span className="text-xs font-bold text-current block flex items-center gap-1">
                    ...
                    <div className="w-10 h-10 rounded-full bg-[#FF7A1A]/10 border border-[#FF7A1A]/40 text-[#FF7A1A] flex items-center justify-center group-hover:bg-[#FF7A1A] group-hover:text-white transition-all shadow-md">
