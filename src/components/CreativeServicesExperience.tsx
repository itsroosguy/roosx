...
interface CreativeServicesExperienceProps {
  onOpenInquiry?: () => void;
  isDarkMode?: boolean;
}
...
export const CreativeServicesExperience: React.FC<CreativeServicesExperienceProps> = ({
  isDarkMode = false,
}) => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          {/* Left Column: Numbered Architectural Service List (Staggered Scroll Entrance) */}
          <motion.div
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${
                        isSelected
                          ? 'bg-[#F97316] text-white rotate-45 scale-110 shadow-md shadow-[#F97316]/40'
                          : isDarkMode
          ...
          {/* Right Column: Dynamic Stage Card with Smooth Motion Entrance */}
          <motion.div
              ...
              >
                ...
                <motion.div
                  ...
                  className={`absolute -top-24 -right-24 w-80 h-80 rounded-full blur-3xl pointer-events-none ${
                    isDarkMode
                      ? 'bg-gradient-to-br from-[#F97316]/25 to-[#FDBA74]/15'
                      : 'bg-gradient-to-br from-[#F97316]/15 to-[#FDBA74]/10'
                  }`}
                />
                ...
                >
                  <div className="flex items-center gap-3">
                    <motion.div
                      ...
                      className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#F97316] via-[#FB923C] to-[#EA580C] text-white flex items-center justify-center shadow-lg shadow-[#F97316]/30 border border-[#FDBA74]/40"
                    >
