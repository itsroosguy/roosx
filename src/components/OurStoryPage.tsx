...
export const OurStoryPage: React.FC<OurStoryPageProps> = ({
  ...
  const journeyMilestones = [
    {
      num: '01',
      title: 'Foundational Brand Positioning',
      description: 'We build the high-authority basement for your business — sharp strategic positioning, core messaging architecture, and visual identity systems that build immediate market trust.',
      deliverables: ['Strategic Brand Positioning', 'Identity System', 'Core Messaging Architecture'],
      icon: Shield,
    },
    {
      num: '02',
      title: 'High-Conversion Product Polish',
      description: 'We refine early-stage and growing concepts into market-ready assets — polishing value propositions, user flows, and conversion touchpoints for venture validation.',
      deliverables: ['Value Proposition Polish', 'High-Fidelity Web Assets', 'Conversion Flow Validation'],
      icon: Sparkles,
    },
    {
      num: '03',
      title: 'Category-Defining Digital Platform',
      description: 'We build high-performance 3D spatial web experiences and bespoke React applications engineered to command market authority and drive customer acquisition.',
      deliverables: ['High-Conversion 3D Web Experience', 'Cinematic Motion Design', 'Customer Acquisition Engines'],
      icon: Flame,
    },
    {
      num: '04',
      title: 'Design & Revenue Balance',
      description: 'We maintain the ideal equilibrium between world-class creative design and measurable business outcomes — ensuring every visual asset directly drives bottom-line growth.',
      deliverables: ['CRO Optimization', 'Multi-Channel Consistency', 'Brand & Performance Telemetry'],
      icon: Scale,
    },
    {
      num: '05',
      title: 'Executive Co-Pilot Partnership',
      description: 'We operate as a direct extension of your executive team — aligning brand vision, technology architecture, and growth execution with zero account manager layer.',
      deliverables: ['Dedicated Co-Pilot Partnership', 'Executive Advisory', 'Unified Team Execution'],
      icon: Users,
    },
    {
      num: '06',
      title: 'Autonomous AI & Future Scale',
      description: 'We implement scalable React codebases and autonomous AI workflow automations so your business operates with speed, efficiency, and long-term market dominance.',
      deliverables: ['Autonomous AI Automation', 'Custom React/Next.js Codebase', 'Market Leadership Engine'],
      icon: Target,
    },
  ];
